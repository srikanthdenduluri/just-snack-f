...
theme.Product = (function() {
  function Product(container) {
    ...
    this.selectors = {
      ...
      $productGridImages: $('.grid-link__image--product', this.$container),
    ...
    this.relatedEnabled = this.$container.data('related-enabled') || false;
  ...
  Product.prototype = _.assignIn({}, Product.prototype, {
    init: function() {
      ...
      if (this.relatedEnabled) {
        ...
        theme.equalHeights(this.selectors.$productGridImages);
      }
    },
