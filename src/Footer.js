      ...
      <div id="shopify-section-footer" class="shopify-section">
        <footer class="site-footer small--text-center" role="contentinfo">
          <div class="wrapper">
              ...
              <div class="grid__item two-quarters small--one-whole">
                <div class="footer-nav">
                  <ul class="site-footer__links">
                    <li>
                      <a href="https://smartbox-express.com/account/login">
                        My Account
                      </a>
                    </li>
                    ...
                    <li>
                      <a href="https://smartboxcompany.com/pages/smartbox-for-business">
                        SmartBox For Business
                      </a>
                    </li>

                    <li>
                      <a href="https://smartboxcompany.com/blogs/news">News</a>
                    </li>
                    ...
                    <li>
                      <a href="https://smartboxcompany.com/pages/privacy-policy">
                        Privacy Policy
                      </a>
                    </li>

                    <li>
                      <a href="https://smartboxcompany.com/policies/refund-policy">
                        Refund Policy
                      </a>
                    </li>

                    <li>
                      <a href="https://smartboxcompany.com/pages/contact">
                        Contact
                      </a>
                    </li>
                  </ul>
            ...
            <hr class="hr--small hr--clear"></hr>

            <div class="grid">
              <div class="grid__item text-center">
                <p class="copyright-text site-footer__links">
                  Copyright © 2021{" "}
                  <a href="https://smartboxcompany.com/" title="">
                    SmartBox
                  </a>{" "}
                  | All Rights Reserved
                </p>
